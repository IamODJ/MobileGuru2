...
public class cpsir extends AppCompatActivity {
...
View om;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("https://www.cpprashanth-chemistry.com/xii/quick-revision-materials");
    ...
    public void onBackPressed() {
        if(webview.canGoBack()) {
            ...
            Intent i=new Intent(cpsir.this,PocketSphinxActivity.class);
            startActivity(i);
        }
    }
}